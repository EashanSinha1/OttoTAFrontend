...
const SignInWidget: FC<SignInWidgetProps> = ({ onSignIn, signInText}) => {
    ...
    return (
        ...
        <div className="w-[543px] h-[105px] relative cursor-pointer" onClick={signIn}>
            {signInText}
            <div className="w-[543px] h-[105px] left-0 top-0 absolute bg-white rounded-[20px] border-2 border-neutral-400" />
            <div className="left-[129px] top-[26px] absolute text-center text-neutral-400 text-[35px] font-medium no-select cursor-pointer">Continue with Google</div>
