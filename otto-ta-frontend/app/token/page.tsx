    ...
    <div className={lexend.className}>
     {/* <div className="w-[1728px] h-[1117px] relative bg-gradient-to-r from-purple-700 to-fuchsia-400"> */}
        <div className="w-[1254px] h-[600px] left-[237px] top-[180px] absolute bg-white rounded-[60px]">
            <div className="left-[147px] top-[90px] absolute justify-center text-center text-black text-6xl font-medium font-lexend tracking-custom">Let’s get to know more about you</div>
            <div className="left-[162px] top-[188px] absolute text-center text-zinc-600 text-3xl font-medium font-lexend tk-sub-title tracking-custom">Input your canvas auth token so we can import your course data</div>
            ...
            <div className="w-[868px] h-[65px] left-[193px] top-[240px] absolute">
              <div className="w-[868px] h-[65px]  bg-white rounded-[15px] border-2 border-zinc-600">
                <input type="text" placeholder="Enter your Canvas auth token here" className="w-full h-full rounded-[15px] pl-2" onChange={handleInputChange}/>
              </div>
            </div>
                

            <button className="absolute w-[260px] h-12 left-[497px] top-[330px] bg-purple-600 rounded-[14px] flex items-center justify-center hover:bg-purple-400 hover:text-white transition duration-300" onClick={handleClick}>
              <span className="text-center text-white text-xl font-medium">Submit</span>
            </button>
