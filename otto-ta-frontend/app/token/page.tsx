...
const TokenPage: FC = () => {
  ...
  const handleClick = async (e: MouseEvent<HTMLButtonElement>) => {
    ...
    const status = await fetch("https://back.otto-ta.tech/verifyCanvasApi/" + token)
  ...
  return (
    ...
    <div className={lexend.className}>
     {/* <div className="w-[1728px] h-[1117px] relative bg-gradient-to-r from-purple-700 to-fuchsia-400"> */}
        <div className="w-[1254px] h-[800px] left-[237px] top-[103px] absolute bg-white rounded-[60px]">
            <div className="left-[147px] top-[90px] absolute justify-center text-center text-black text-6xl font-medium font-lexend">Let’s get to know more about you</div>
            <div className="left-[162px] top-[188px] absolute text-center text-zinc-600 text-3xl font-medium font-lexend">Input your canvas auth token so we can import your course data</div>
            <div className="w-[868px] h-[65px] left-[193px] top-[285px] absolute">
                <div className="w-[868px] h-[65px] left-0 top-0 absolute bg-white rounded-[15px] border-2 border-zinc-600" />
                {/* <div className="w-[400px] left-[26px] top-[21px] absolute text-neutral-400 text-xl font-semibold font-['Inter']">Enter your Canvas auth token here</div> */}
                <input type="text" placeholder="Enter your Canvas auth token here" className="w-[400px] left-[26px] top-[21px] absolute text-neutral-400 text-xl font-regular font-lexend" onChange={handleInputChange}/>
            </div>
