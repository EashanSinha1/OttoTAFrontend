...
const FlashcardPlayPage: FC = () => {
  ...
  const [cardInfo, setCardInfo] = useState({
    "question": "Prove that if a language L is regular, then the language obtained by removing specific strings from L is also regular.",
    "answer": "If a language L is regular, then the language obtained by removing specific strings from L while preserving the regular structure is also regular.",
...
const maxDex = 10;
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center py-0 bg-gradient-to-br from-purple-700 to-purple-300/90">
      ...
      >Flashcard {currentIndex}/{maxDex}</h1>
      <FlippableCard
